  ...
  return (
    <section className="relative min-h-[90vh] flex items-center justify-center pt-20 overflow-hidden">
      <div className="container mx-auto px-6 relative z-10 flex flex-col md:flex-row gap-12 items-center justify-between">
        ...
        {/* Zodiac Compass - Trazido para o fluxo para melhor controle responsivo e nitidez */}
        <motion.div
        ...
        >
          <div className="w-[320px] h-[320px] md:w-[500px] lg:w-[600px] md:h-[500px] lg:h-[600px]">
            <ZodiacCompass />
          </div>
        </motion.div>
      </div>
